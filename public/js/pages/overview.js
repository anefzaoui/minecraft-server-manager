// World quick-controls rail (all tabs): time, weather, gamerules, difficulty,
// plus a live in-game clock. The clock ticks locally (20 ticks/s) between
// RCON resyncs so it stays honest even right after a /time set intervention.
  ...
  async function refreshState() {
    ...
    try {
      ...
      if (typeof s.timeTicks === 'number') {
        ...
        stateLine.textContent = 'World state loaded.';
      }
      // Reflect gamerule states on the toggle chips.
