...
module.exports = [
  ...
  },
  {
    ...
    help: 'Re-copies the imported world over the existing one on every start. Leaving this on permanently wipes player progress at each restart. Enable it once to reset, then turn it back off.',
    type: 'boolean',
    default: false,
    mode: 'advanced',
    section: 'world',
